      ...
      <footer className="py-12 bg-[#0a0e14]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex gap-4">
              <a href="https://github.com/Yigitbdk" target="_blank" rel="noopener noreferrer" className="brutal bg-slate-900/50 p-3 hover:scale-110 hover:rotate-3 transition-all">
              ...
              <a href="https://www.linkedin.com/in/yi%C4%9Fit-badik-953457206/" target="_blank" rel="noopener noreferrer" className="brutal bg-slate-900/50 p-3 hover:scale-110 hover:-rotate-3 transition-all">
